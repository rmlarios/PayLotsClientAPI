#pragma checksum "D:\GIT\PayLotsClientAPI\DevExtremeAspNetCoreResponsiveApp\Pages\Pago\Listado.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "d520d9a5a4f9e496fc563732dc208f2239be242d"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"d520d9a5a4f9e496fc563732dc208f2239be242d", @"/Pages/Pago/Listado.cshtml")]
...
Write(Html.DevExtreme().DataGrid<ViewPagosAsignaciones>
    ...
    PopWriter();
        ...
        .Caption("Asignacion").Lookup(c => c.DataSource(d => d.Mvc().Controller("Asignaciones").LoadAction("GetAll")).DisplayExpr(new JS("groupDisplay")).ValueExpr("IdAsignacion"));
                        ...
                        columns.AddFor(m => m.Saldo).Visible(false);
                    ...
                    .Summary(c=>c.GroupItems(g=> {
                        g.AddFor(m => m.MontoPago).ShowInColumn("MontoPago").Column("MontoPago").SummaryType(SummaryType.Sum);
                        g.AddFor(m => m.Saldo).Column("Saldo").SummaryType(SummaryType.Avg);
                    }))
...
#nullable restore
#line 137 "D:\GIT\PayLotsClientAPI\DevExtremeAspNetCoreResponsiveApp\Pages\Pago\Listado.cshtml"
