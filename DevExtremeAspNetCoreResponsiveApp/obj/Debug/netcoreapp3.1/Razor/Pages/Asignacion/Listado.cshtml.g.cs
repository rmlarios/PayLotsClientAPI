#pragma checksum "D:\Repository\rmlarios\PayLotsClientAPI\DevExtremeAspNetCoreResponsiveApp\Pages\Asignacion\Listado.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "cbc7e15ac3eab38ef23af731e50f185da8f637c2"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"cbc7e15ac3eab38ef23af731e50f185da8f637c2", @"/Pages/Asignacion/Listado.cshtml")]
    ...
    public class Pages_Asignacion_Listado : global::Microsoft.AspNetCore.Mvc.RazorPages.Page
    {
        ...
        {
#nullable restore
#line 3 "D:\Repository\rmlarios\PayLotsClientAPI\DevExtremeAspNetCoreResponsiveApp\Pages\Asignacion\Listado.cshtml"
   
    TempData["ReportName"] = "PlandePago";
    ViewData["Title"] = "Asignaciones Registradas";
...
#nullable restore
#line 12 "D:\Repository\rmlarios\PayLotsClientAPI\DevExtremeAspNetCoreResponsiveApp\Pages\Asignacion\Listado.cshtml"
...
#nullable disable
            WriteLiteral("  ");
#nullable restore
#line 15 "D:\Repository\rmlarios\PayLotsClientAPI\DevExtremeAspNetCoreResponsiveApp\Pages\Asignacion\Listado.cshtml"
...
#nullable disable
            WriteLiteral("\r\n    </div>\r\n</div>\r\n\r\n\r\n");
#nullable restore
#line 32 "D:\Repository\rmlarios\PayLotsClientAPI\DevExtremeAspNetCoreResponsiveApp\Pages\Asignacion\Listado.cshtml"
Write(Html.DevExtreme().DataGrid<ViewAsignacionesSaldo>
                    ...
                    .Columns(columns =>
                    {
                        ...
                        buttons.Add().Name("PlanPago").Hint("Ver Plan de Pago").Icon("fa fa-calendar").Visible(new JS("isPlanVisible")).OnClick("printPlan");
                        buttons.Add().Name("Activar").Hint("Activar").Icon("check").Visible(new JS("isActivarVisible")).OnClick("activar");
                        buttons.Add().Name("EstadoCuenta").Hint("Estado de Cuenta").Icon("fa fa-calculator").Visible(new JS("isPlanVisible")).OnClick("printEstado");
                    });
       })
...
#nullable restore
#line 123 "D:\Repository\rmlarios\PayLotsClientAPI\DevExtremeAspNetCoreResponsiveApp\Pages\Asignacion\Listado.cshtml"
Write(Html.DevExtreme().Popup
    ...
    WriteLiteral("                \r\n");
#nullable restore
#line 132 "D:\Repository\rmlarios\PayLotsClientAPI\DevExtremeAspNetCoreResponsiveApp\Pages\Asignacion\Listado.cshtml"
...
#nullable disable
#nullable restore
#line 136 "D:\Repository\rmlarios\PayLotsClientAPI\DevExtremeAspNetCoreResponsiveApp\Pages\Asignacion\Listado.cshtml"
...
#nullable disable
#nullable restore
#line 146 "D:\Repository\rmlarios\PayLotsClientAPI\DevExtremeAspNetCoreResponsiveApp\Pages\Asignacion\Listado.cshtml"
                                 }
...
#nullable restore
#line 158 "D:\Repository\rmlarios\PayLotsClientAPI\DevExtremeAspNetCoreResponsiveApp\Pages\Asignacion\Listado.cshtml"
    ...
    function activar(e) {
        ...
        //alert(IdAsignacionS);
         $.ajax({
                ...
                url: '");
#nullable restore
#line 186 "D:\Repository\rmlarios\PayLotsClientAPI\DevExtremeAspNetCoreResponsiveApp\Pages\Asignacion\Listado.cshtml"
...
#nullable restore
#line 214 "D:\Repository\rmlarios\PayLotsClientAPI\DevExtremeAspNetCoreResponsiveApp\Pages\Asignacion\Listado.cshtml"
...
#nullable disable
  ...
  ");
        ...
        window.open('/Reportes/Viewer?r=pp&p=' + IdAsignacionS, '_newtab');
        //window.location.href = ""/ReportViewer/?p="";
    }
    function printEstado(e) {
        window.open('/Reportes/EstadoCuenta/?id=' + e.row.key, '_newtab');
    }
    ...
    function isA");
            WriteLiteral(@"ctivarVisible(e) {
        return !e.row.isEditing && e.row.data.Estado == ""Anulada"" && hideCommand();
    }

    function isPlanVisible(e) {
...
#nullable restore
#line 304 "D:\Repository\rmlarios\PayLotsClientAPI\DevExtremeAspNetCoreResponsiveApp\Pages\Asignacion\Listado.cshtml"
...
#nullable restore
#line 309 "D:\Repository\rmlarios\PayLotsClientAPI\DevExtremeAspNetCoreResponsiveApp\Pages\Asignacion\Listado.cshtml"
...
#nullable disable
            WriteLiteral("\";\r\n        if (existrole != \"\") {\r\n            var role = \"");
#nullable restore
#line 311 "D:\Repository\rmlarios\PayLotsClientAPI\DevExtremeAspNetCoreResponsiveApp\Pages\Asignacion\Listado.cshtml"
                   Write(User.Claims.FirstOrDefault(c => c.Type.Equals("rol")));
