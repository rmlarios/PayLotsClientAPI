#pragma checksum "D:\GIT\PayLotsClientAPI\DevExtremeAspNetCoreResponsiveApp\Pages\Reportes\EstadoCuenta.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "7ffa46e94ad12eb033e93752f24f6c247b6f5813"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"7ffa46e94ad12eb033e93752f24f6c247b6f5813", @"/Pages/Reportes/EstadoCuenta.cshtml")]
...
#line hidden
#nullable disable
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("link", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "7ffa46e94ad12eb033e93752f24f6c247b6f58134879", async() => {
            }
            );
...
#nullable restore
#line 10 "D:\GIT\PayLotsClientAPI\DevExtremeAspNetCoreResponsiveApp\Pages\Reportes\EstadoCuenta.cshtml"
    Write(Html.DevExtreme().Lookup().Placeholder("Seleccione la Asignacion").SearchEnabled(true).SearchMode(DropDownSearchMode.Contains).SearchExpr("DatoCompleto").StylingMode(EditorStylingMode.Outlined).DisplayExpr("DatoCompleto").ValueExpr("IdAsignacion").DataSource(
        c=>c.Mvc().Controller("Asignaciones").LoadAction("GetAll").Key("IdAsignacion")).OnSelectionChanged(
...
#nullable restore
#line 25 "D:\GIT\PayLotsClientAPI\DevExtremeAspNetCoreResponsiveApp\Pages\Reportes\EstadoCuenta.cshtml"
    Write(Html.DevExpress().WebDocumentViewer("Viewer").Height("600px").Bind(Model.rptEstadoCuenta)
    );
